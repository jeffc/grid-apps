...
export function createPopOps() {
    ...
    createPopOp('adaptive', {
        ...
        bounds: 'camAdaptiveBounds',
        clearFirst: 'camAdaptiveClearFirst',
        omitthru: 'camAdaptiveOmitThru',
        helixMin: 'camAdaptiveHelixMin',
        helixMax: 'camAdaptiveHelixMax',
        rampAngle: 'camAdaptiveRampAngle',
        ov_topz: 0,
        ov_botz: 0,
    }).inputs = {
        tool: UC.newSelect(LANG.cc_tool, {}, "tools"),
        ...
        sep: UC.newBlank({ class: "pop-sep" }),
        bounds: UC.newSelect("boundary treatment", {}, "boundtreat"),
        omitthru: UC.newBoolean(LANG.co_omit_s, undefined, { title: LANG.co_omit_l }),
        clearFirst: UC.newBoolean("clear large regions first", undefined, { title: "clear large regions (breadth-first) before slotting" }),
        sep: UC.newBlank({ class: "pop-sep" }),
        ...
        rampAngle: UC.newInput("ramp angle", { title: "descent angle for contour ramp entry in degrees (default 2)", convert: toFloat, bound: UC.bound(0.1, 45.0) }),
        sep: UC.newBlank({ class: "pop-sep" }),
