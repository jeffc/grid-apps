    ...
    findPathTSP(startNode) {
        ...
        while (unvisited.size > 0) {
            ...
            if (nearestNeighbor) {
                ...
                edges.push({ from: currentNode, to: nearestNeighbor, edgeData: connectingEdge }); // Store the edge
        ...
        if (closingEdgeObj !== undefined) {
            ...
            edges.push({ from: lastNodeInPath, to: startNode, edgeData: closingEdgeObj }); // Store closing edge
            path.push(startNode);
        }
